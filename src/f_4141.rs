...
pub const ORD: FSecp256Ord = FSecp256Ord { v: [0xBFD25E8CD0364141, 0xBAAEDCE6AF48A03B, 0xFFFFFFFFFFFFFFFE, 0xFFFFFFFFFFFFFFFF] };
...
impl FSecp256Ord {
    ...
    fn reduce512(l0: u128, l1: u128, l2: u128, l3: u128, l4: u128, l5: u128, l6: u128, l7: u128) -> FSecp256Ord {
...
impl Ford for FSecp256Ord {
    ...
    fn add(&self, b: &FSecp256Ord) -> FSecp256Ord {
        ...
        // return overflow;
        let r = FSecp256Ord { v: [r0 as u64, r1 as u64, r2 as u64, r3 as u64] };
        FSecp256Ord::reduce(&r, t as u64)
    }    

    fn neg(&self) -> FSecp256Ord {
        let m = if self.is_zero() { 0 } else { 0xFFFFFFFFFFFFFFFF };
        ...
        let r = FSecp256Ord { v:[r0, r1, r2, r3] };
...
//     fn inv(&self) -> Self;
    ...
    fn from_bytes(b: &[u8]) -> Self {
        if b.len()<32 { panic!("calling from_bytes on a small slice"); }
// static void secp256k1_scalar_set_b32(secp256k1_scalar *r, const unsigned char *b32, int *overflow) {
        let r0 = b[31] as u64   | (b[30] as u64) << 8 | (b[29] as u64) << 16 | (b[28] as u64) << 24 | (b[27] as u64) << 32 | (b[26] as u64) << 40 | (b[25] as u64) << 48 | (b[24] as u64) << 56;
        let r1 = (b[23] as u64) | (b[22] as u64) << 8 | (b[21] as u64) << 16 | (b[20] as u64) << 24 | (b[19] as u64) << 32 | (b[18] as u64) << 40 | (b[17] as u64) << 48 | (b[16] as u64) << 56;
        let r2 = (b[15] as u64) | (b[14] as u64) << 8 | (b[13] as u64) << 16 | (b[12] as u64) << 24 | (b[11] as u64) << 32 | (b[10]as u64) << 40 | (b[9] as u64)<< 48 | (b[8] as u64)<< 56;
        let r3 = (b[7]  as u64) | (b[6] as u64) << 8 | (b[5] as u64) << 16 | (b[4] as u64) << 24 | (b[3] as u64) << 32 | (b[2] as u64) << 40 | (b[1] as u64) << 48 | (b[0] as u64) << 56;
        let r = FSecp256Ord { v: [r0, r1, r2, r3] };
        FSecp256Ord::reduce(&r, 0)
...
//     }
    ...
    fn to_bytes(&self, b: &mut [u8]) {
        if b.len()<32 { panic!("using to_bytes on a small slice"); }
        b[0] = (self.v[3] >> 56) as u8; b[1] = (self.v[3] >> 48) as u8; b[2] = (self.v[3] >> 40) as u8; b[3] = (self.v[3] >> 32) as u8; 
        b[4] = (self.v[3] >> 24) as u8; b[5] = (self.v[3] >> 16) as u8; b[6] = (self.v[3] >> 8) as u8; b[7] = self.v[3] as u8;
        b[8] = (self.v[2] >> 56) as u8; b[9] = (self.v[2] >> 48) as u8; b[10] = (self.v[2] >> 40) as u8; b[11] = (self.v[2] >> 32) as u8; 
        b[12] = (self.v[2] >> 24) as u8; b[13] = (self.v[2] >> 16) as u8; b[14] = (self.v[2] >> 8) as u8; b[15] = self.v[2] as u8;
        b[16] = (self.v[1] >> 56) as u8; b[17] = (self.v[1] >> 48) as u8; b[18] = (self.v[1] >> 40) as u8; b[19] = (self.v[1] >> 32) as u8; 
        b[20] = (self.v[1] >> 24) as u8; b[21] = (self.v[1] >> 16) as u8; b[22] = (self.v[1] >> 8) as u8; b[23] = self.v[1] as u8;
        b[24] = (self.v[0] >> 56) as u8; b[25] = (self.v[0] >> 48) as u8; b[26] = (self.v[0] >> 40) as u8; b[27] = (self.v[0] >> 32) as u8; 
        b[28] = (self.v[0] >> 24) as u8; b[29] = (self.v[0] >> 16) as u8; b[30] = (self.v[0] >> 8) as u8; b[31] = self.v[0] as u8;
    }
...
//     fn swap(a: &mut Self, b: &mut Self, sel:u32);
    ...
    fn mul(&self, b: &FSecp256Ord) -> FSecp256Ord {
        ...
        let l2 = ov + (t01 >> 64) + (t02 & LOWER64) + (t10 >> 64) + (t11 & LOWER64) + (t20 & LOWER64);
        let ov = l2 >> 64;
        let l2 = l2 & LOWER64;
        ...
        let l3 = ov + (t02>>64) + (t03&LOWER64) + (t11>>64) + (t12 & LOWER64) +
                (t20 >> 64) + (t21 & LOWER64) + (t30 & LOWER64);
        let ov = l3 >> 64;
        let l3 = l3 & LOWER64;
        ...
        let l4 = ov + (t03 >> 64) + (t12 >> 64) + (t13 & LOWER64) + (t21 >> 64) +
                (t22 & LOWER64) + (t30 >> 64) + (t31 & LOWER64);
        let ov = l4 >> 64;
        let l4 = l4 & LOWER64;
...
fn secp256k1_ord_mul_tests() {
    ...
    let a = FSecp256Ord { v: [ 0x7cf1bb69abb65af4, 0x895226b5e95d05a4, 0, 0 ] };
    let b = FSecp256Ord { v: [ 0xe2da678a3bd9f587, 0x4bac621d4ea8a910, 0, 0 ] };
    let c = FSecp256Ord { v: [ 0x3da8be2067097aac, 0x720c36a46b88884c, 0x25ad0ca524dfd0c8, 0x2897892a78e8917d ] };
    let d = a.mul(&b);
    assert!(c==d);

    let a = FSecp256Ord { v: [ 0x7cf1bb69abb65af4, 0x895226b5e95d05a4, 0xfda3e96dd6e46282, 0xe8f4a37d6822745c ] };
    let b = FSecp256Ord { v: [ 0xe2da678a3bd9f587, 0x4bac621d4ea8a910, 0xc1ef8744f93ea5bf, 0xc312a8317baa6ef8 ] };
    let c = FSecp256Ord { v: [ 0xe50869bae6e498b1, 0x7a8fb650e90e23a0, 0xf7dfab85418e2d39, 0x8fd65c3ba8ea7394 ] };
    let d = a.mul(&b);
    assert!(c==d);

    let a = FSecp256Ord { v: [ 0x683815888e0d92f4, 0xf0c09326565cd85c, 0x16c582d119939355, 0x23f5beeebe460ab2 ] };
    let b = FSecp256Ord { v: [ 0x3c3429ef8429d1, 0xf5e4f42942510923, 0x3ca4c3b30a24e04d, 0xf681f880579d369e ] };
    let c = FSecp256Ord { v: [ 0x99c75ab576f0eaea, 0x2ce1fef91c39ae4e, 0x7f005bffd186bcb5, 0x50b998e17524c7d6 ] };
    let d = a.mul(&b);
    assert!(c==d);

    let a = FSecp256Ord { v: [ 0x433a24161f6f745d, 0x488fd4c542fdfb78, 0x4e9cf66908bb7e2f ,0xed805549c354f6ab] };
    let b = FSecp256Ord { v: [ 0xd8763fc041b37c40, 0xa8f9a298fd273ca0, 0xa9a4767a7b9aed8b ,0x480a21b26398b137] };
    let c = FSecp256Ord { v: [ 0xcedc7e2a92366974, 0x187c06863a07b247, 0xd91ac60a8472bdb2 ,0xa3952ee002fc816e] };
    let d = a.mul(&b);
    assert!(c==d);

    let a = FSecp256Ord { v: [ 0x13f11ca9caac665f , 0xaa9172e1f1644a9 , 0x9fd9a89af800a9c4 ,0x29b811c09192a9aa] };
    let b = FSecp256Ord { v: [ 0x84d0a83965fe3861 , 0x5f3d5e3fa97a750e , 0xb1d9e0446088fcd8 ,0xf0c38823260ac6a5] };
    let c = FSecp256Ord { v: [ 0xd0f897566ef28356 , 0xdcc5ffbabecfb80a , 0xd750a4e63e7815ad ,0xd2f688b634d5c47c] };
    let d = a.mul(&b);
    assert!(c==d);

    let a = FSecp256Ord { v: [0xe95905861ab01e7d, 0x5efbbcf92263b64f, 0xbef6609471a10c6b, 0xef41826d28c2c6fa] };
    let b = FSecp256Ord { v: [0x33c0eb7d6b0d5495, 0x354c3bf89d0ed9e8, 0x27a17a9b0f3cda50, 0xbdf099620c387e55] };
    let c = FSecp256Ord { v: [0xd1f8fa316b5ba849, 0x1754adf586713033, 0x78fc16390d7e09df, 0x88abfa378719eb29] };
    let d = a.mul(&b);
    assert!(c==d);

    let a = FSecp256Ord { v: [ 0x0 , 0x0 , 0xfffffffffffffffe ,0xffffffffffffffff] };
    let b = FSecp256Ord { v: [ 0xbfd25e8cd0364140 , 0xbaaedce6af48a03b , 0xfffffffffffffffe ,0xffffffffffffffff] };
    let c = FSecp256Ord { v: [ 0xbfd25e8cd0364141 , 0xbaaedce6af48a03b , 0x0 ,0x0] };
    let d = a.mul(&b);
    assert!(c==d);

    let a = FSecp256Ord { v: [0xffffffffffffffff, 0xffffffffffffffff, 0xfffffffffffffffd, 0xffffffffffffffff] };
    let b = FSecp256Ord { v: [0xbfd25e8cd0364140, 0xbaaedce6af48a03b, 0xfffffffffffffffe, 0xffffffffffffffff] };
    let c = FSecp256Ord { v: [0xbfd25e8cd0364142, 0xbaaedce6af48a03b, 0x0, 0x0] };
    let d = a.mul(&b);
    assert!(c==d);
    
    let a = FSecp256Ord { v: [0xbfd25e8cc0364142, 0xbaaedce6af48a03b, 0xfffffffffffffffe, 0xffffffffffffffff] };
    let b = FSecp256Ord { v: [0xbfd25e8cd0364140, 0xbaaedce6af48a03b, 0xfffffffffffffffe, 0xffffffffffffffff] };
    let c = FSecp256Ord { v: [0xfffffff, 0x0, 0x0, 0x0] };
    let d = a.mul(&b);
    assert!(c==d);
}
...
fn secp256k1_ord_sub_tests() {
    let a = FSecp256Ord { v: [ 0x433a24161f6f745d, 0x488fd4c542fdfb78, 0x4e9cf66908bb7e2f ,0xed805549c354f6ab] };
    let a2 = FSecp256Ord { v: [0xe95905861ab01e7d, 0x5efbbcf92263b64f, 0xbef6609471a10c6b, 0xef41826d28c2c6fa] };
    let a3 = a.add(&a2);
    let a4 = a3.sub(&a);
    assert!(a4==a2);
}
